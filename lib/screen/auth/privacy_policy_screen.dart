                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      _buildParagraph(
                                        text: 'Cảm ơn bạn đã sử dụng dịch vụ của chúng tôi. Để truy cập và trải nghiệm ứng dụng Walkamon, bạn có thể phải đăng ký tài khoản. Bằng việc truy cập hay sử dụng dịch vụ, bạn xác nhận rằng bạn đã đọc, hiểu và đồng ý bị ràng buộc bởi Điều khoản Dịch vụ này.',
                                        theme: theme,
                                      ...
                                      // PHẦN 1
                                      _buildPartHeader(
                                        title: 'PHẦN 1: QUY ĐỊNH ĐIỀU KHOẢN THÀNH VIÊN',
                                        accent: accent,
                                      ),
                                      ...
                                      _buildSubSection(
                                        title: '2. Quy định về đặt tên tài khoản và nhân vật',
                                        content: '• Tên tài khoản và nhân vật bao gồm các ký tự chữ và số, không bao gồm ký tự đặc biệt, có độ dài tối thiểu 6 ký tự và tối đa 16 ký tự.\n'
                                      ...
                                      _buildSubSection(
                                        title: '3. Quy định về lưu trữ, bảo mật và xóa dữ liệu người dùng',
                                      ...
                                      _buildSubSection(
                                        title: '4. Các hành vi người dùng bị nghiêm cấm',
                                        content: 'Người dùng tuyệt đối không được lợi dụng trò chơi điện tử để thực hiện các hành vi vi phạm pháp luật. Cụ thể nghiêm cấm:\n'
                                      ...
                                      _buildSubSection(
                                        ...
                                        content: 'Walkamon có thể chấm dứt tài khoản của bạn khi chúng tôi có lý do để tin rằng tài khoản đó vi phạm hoặc đã không tuân thủ Điều khoản Dịch vụ.',
                                        theme: theme,
                                        foreground: foreground,
                                        mutedForeground: mutedForeground,
                                      ),
                                      ...
                                      // PHẦN 2
                                      _buildPartHeader(
                                        title: 'PHẦN 2: QUY ĐỊNH VỀ QUẢN LÝ NỘI DUNG, THÔNG TIN VÀ HOẠT ĐỘNG TRÒ CHƠI',
                                        accent: accent,
                                      ),
                                      const SizedBox(height: 16),

                                      _buildSubSection(
                                        title: '1. Quản lý nội dung và cơ chế xử lý vi phạm',
                                        content: '• Quyền cấp phép nội dung: Bằng việc gửi nội dung (bình luận, hình ảnh...) lên hệ thống, bạn cấp cho chúng tôi quyền sử dụng, tái tạo và xuất bản các nội dung đó. Chúng tôi không tuyên bố quyền sở hữu nhưng có quyền từ chối hoặc xóa bất kỳ nội dung nào vi phạm.\n'
                                      ...
                                      _buildSubSection(
                                        title: '2. Phân loại độ tuổi và quản lý thời gian chơi',
                                        content: '• Phân loại độ tuổi: Các trò chơi trên nền tảng được phân loại theo độ tuổi (00+, 12+, 16+, 18+) được hiển thị liên tục trong quá trình chơi và trên các nội dung quảng cáo. Người chơi có nghĩa vụ lựa chọn trò chơi phù hợp với độ tuổi của mình.\n'
                                      ...
                                      _buildSubSection(
                                        title: '3. Quản lý vật phẩm ảo, tính năng nâng cấp và điểm thưởng',
                                        content: '• Mục đích sử dụng: Trò chơi chỉ cung cấp các vật phẩm ảo, điểm thưởng, và tính năng nâng cấp đã được thiết lập sẵn trong từng game. Người chơi nhận được các tính năng này thông qua việc tham gia trò chơi hoặc xem quảng cáo. Mọi vật phẩm và tính năng chỉ được sử dụng trong phạm vi trò chơi đang chơi.\n'
                                      ...
                                      _buildSubSection(
                                        title: '4. Bản quyền và Sở hữu trí tuệ',
                                        content: '• Tất cả Quyền sở hữu trí tuệ liên quan tới Dịch vụ, phần mềm, văn bản, video, âm thanh, hình ảnh chứa trên Dịch vụ (ngoại trừ Nội dung do Người dùng tự tạo) đều thuộc về Walkamon và bên cấp phép của chúng tôi.\n'
                                      ...
                                      const SizedBox(height: 8),
                                      _buildParagraph(
                                        text: 'Hãy liên lạc với chúng tôi khi có bất kỳ thắc mắc hoặc để báo cáo bất kỳ hành vi vi phạm các Điều khoản Dịch vụ theo địa chỉ email: walkamonn@gmail.com\n\n'
